...
import br.cefetmg.cameraviewer.config.audit.AuditEventConverter;
import br.cefetmg.cameraviewer.domain.PersistentAuditEvent;
...
import static br.cefetmg.cameraviewer.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
